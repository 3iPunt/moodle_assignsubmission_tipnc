...
$settings->add(new admin_setting_configselect('assignsubmission_tipnc/viewmode',
...
$settings->add(new admin_setting_configtext('assignsubmission_tipnc/docserverurl',
    new lang_string('docserverurl', 'assignsubmission_tipnc'),
    new lang_string('docserverurl_help', 'assignsubmission_tipnc'), '', PARAM_RAW_TRIMMED));

$settings->add(new admin_setting_configpasswordunmask('assignsubmission_tipnc/docserversecret',
    new lang_string('docserversecret', 'assignsubmission_tipnc'),
    new lang_string('docserversecret_help', 'assignsubmission_tipnc'), ''));

$settings->add(new admin_setting_configcheckbox('assignsubmission_tipnc/confirmsaved',
...
$settings->add(new admin_setting_configselect('assignsubmission_tipnc/shareexpiry',
...
$settings->add(new admin_setting_configselect('assignsubmission_tipnc/ondeletesubmission',
...
$settings->add(new admin_setting_configselect('assignsubmission_tipnc/ondeleteassign',
...
$settings->add(new admin_setting_configselect('assignsubmission_tipnc/placement',
...
$settings->add(new admin_setting_configtext('assignsubmission_tipnc/placementselector',
...
$settings->add(new admin_setting_configselect('assignsubmission_tipnc/pagewidth',
...
$settings->add(new admin_setting_configselect('assignsubmission_tipnc/frameheight',
...
$settings->add(new admin_setting_description('assignsubmission_tipnc/desc',
    new lang_string('log_title', 'assignsubmission_tipnc'),
    html_writer::link($logurl, get_string('log_open', 'assignsubmission_tipnc'),
        ['class' => 'btn btn-secondary'])));

$settings->add(new admin_setting_configtext('assignsubmission_tipnc/logretention',
    new lang_string('logretention', 'assignsubmission_tipnc'),
    new lang_string('logretention_help', 'assignsubmission_tipnc'), 90, PARAM_INT));
