...
$string['host_help'] = 'NextCloud domain, container name recommended. Ex: dd-apps-nextcloud-nginx';
$string['url'] = 'URL NextCloud';
$string['url_help'] = 'NextCloud URL allowed in the URL. Ex: https://nextcloud.dd.3ip.eu';
...
$string['location_help'] = 'Part the Nextcloud URL to view the document. Ex: https://nextcloud.montseny.digitaldemocratic.net<strong>/apps/onlyoffice/</strong>3769';
$string['tipnc:view_errors'] = 'View Errors Logs page';
...
$string['tableerrors_method'] = 'Method';
$string['tableerrors_error_code'] = 'Error Code';
...
$string['error_log_desc'] = 'Errors log Table';
$string['tableerrors_coursemodule_delete'] = 'CM Deleted';
